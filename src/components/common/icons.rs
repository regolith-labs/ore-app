...
pub fn SwapIcon(class: Option<String>) -> Element {
    ...
    rsx! {
        svg {
            ...
            path {
                stroke: "currentColor",
                d: "M5.16667 2.6665L5.16667 13.3332M5.16667 13.3332L2.5 10.6665M5.16667 13.3332L7.83333 10.6665M11.8333 13.3332L11.8333 2.6665M11.8333 2.6665L9.16667 5.33317M11.8333 2.6665L14.5 5.33341",
                stroke_width: 2,
                stroke_linecap:"round",
                stroke_linejoin:"round"
            }
...
#[component]
pub fn XCommentIcon(class: Option<String>) -> Element {
    let class = class.unwrap_or("".to_string());
    rsx! {
        svg {
            view_box: "0 0 24 24",
...
#[component]
pub fn XRetweetIcon(class: Option<String>) -> Element {
    let class = class.unwrap_or("".to_string());
    rsx! {
        svg {
            view_box: "0 0 24 24",
...
#[component]
pub fn XLikeIcon(class: Option<String>) -> Element {
    let class = class.unwrap_or("".to_string());
    rsx! {
        svg {
            view_box: "0 0 24 24",
...
#[component]
pub fn XImpressionsIcon(class: Option<String>) -> Element {
    let class = class.unwrap_or("".to_string());
    rsx! {
        svg {
            view_box: "0 0 24 24",
